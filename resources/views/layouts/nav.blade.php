    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="app-navbar-collapse">
            ...
            <ul class="nav navbar-nav">
                <li><a href="/threads">All Threads</a></li> {{--ou {{ url('threads') }}--}}
                <li class="dropdown">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button">Browse <span class="caret"></span></a>
                    <ul class="dropdown-menu">
                        <li><a href="/threads">All Threads</a></li>
                        {{-- @auth<li><a href="/threads?by={{ auth()->user()->name }}">My Threads</a></li>@endauth --}}
                        @if(auth()->check())
            ...
            <ul class="nav navbar-nav navbar-right">
                <!-- Authentication Links -->    {{-- @guest au lieu de Auth:guest() --}}
                @guest  
